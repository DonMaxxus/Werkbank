modded class PlayerBase
{
    ...
    override void Init()
    {
		if ( !GetGame().IsServer() || !GetGame().IsMultiplayer() )
		{
			...
			GetDayZPlayerType().AddItemInHandsProfileIK("CM_Tools_Werkbank", "dz/anims/workspaces/player/player_main/player_main_heavy.asi", heavyItemBehaviour,               "dz/anims/anm/player/ik/heavy/55galDrum.anm");
