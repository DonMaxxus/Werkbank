modded class ModItemRegisterCallbacks
{
	...
	override void RegisterHeavy( DayZPlayerType pType, DayzPlayerItemBehaviorCfg pBehavior )
	{
		...
		pType.AddItemInHandsProfileIK("CM_Tools_Werkbank",  "dz/anims/workspaces/player/player_main/player_main_heavy.asi", pBehavior, "dz/anims/anm/player/ik/heavy/55galDrum.anm");
		...
		pType.AddItemInHandsProfileIK("CM_Tools_Werkbank_Kit",  "dz/anims/workspaces/player/player_main/player_main_heavy.asi", pBehavior, "dz/anims/anm/player/ik/heavy/wooden_crate.anm");
	};
