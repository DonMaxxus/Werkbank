class CraftHud extends UIScriptedMenu
{
    ...
    private const string RedBtn = "CM_Tools_Werkbank/scripts/4_World/layout/redBtn.edds";
    private const string GrnBtn = "CM_Tools_Werkbank/scripts/4_World/layout/greenBtn.edds";
	...
	{
		layoutRoot 				    = 	GetGame().GetWorkspace().CreateWidgets("CM_Tools_Werkbank/scripts/4_World/layout/Workbench.layout");
        ...
        {
            m_MainImg.LoadImageFile(0, "CM_Tools_Werkbank/scripts/4_World/layout/Workbench3.edds");
        }
        FillRecipes();
        FillPosibleRecipes();
		return layoutRoot;
