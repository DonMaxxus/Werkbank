class OneRecipe
{
    ...
    const string    RepairPath = "CM_Tools_Werkbank/scripts/4_World/layout/repair.edds";
    const string    PaintPath = "CM_Tools_Werkbank/scripts/4_World/layout/paint.edds";
    const string    CraftPath = "CM_Tools_Werkbank/scripts/4_World/layout/craft.edds";
    ...
    {
        item = GetGame().GetWorkspace().CreateWidgets("CM_Tools_Werkbank/scripts/4_World/layout/OneItemRecipe.layout", parent);
