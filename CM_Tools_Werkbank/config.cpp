class CfgMods
{
	class CM_Tools_Werkbank
	{
		dir="CM_Tools_Werkbank";
		picture="";
		action="";
		hideName=0;
		hidePicture=1;
		name="CM_Tools_Werkbank";
		...
		class defs
		{
			...
			class worldScriptModule
			{
				...
				files[]=
				{
					"CM_Tools_Werkbank/scripts/4_World"
				};
			};
			class missionScriptModule
			{
				...
				files[]=
				{
					"CM_Tools_Werkbank/scripts/5_Mission"
				};
			};
		};
	};
...
class CfgVehicles
{
	...
	class CM_Tools_Werkbank: Container_Base
	{
		scope=2;
		displayName="Tools Werkbank";
		descriptionShort="Eine Werkbank zum herstellen von Werkzeugen und Materialien";
		model="CM_Tools_Werkbank\workbench.p3d";
		overrideDrawArea=8;
		...
		{
			"CM_Tools_Werkbank\data\workbanch_co_test.paa",
			"CM_Tools_Werkbank\data\workbanch_co_test.paa",
			"CM_Tools_Werkbank\data\workbanch_co_test.paa"
		};
		hologramMaterial="workbench";
		hologramMaterialPath="CM_Tools_Werkbank\data";
		class Cargo
		{
	...
	class CM_Drill: Inventory_Base
	{
		...
		model="CM_Tools_Werkbank\drill.p3d";
		inventorySlot[]=
		{
			"CM_Drill"
		};
	...
	class CM_Cutting_Saw: Inventory_Base
	{
		...
		model="CM_Tools_Werkbank\metal_cutting_saw.p3d";
		inventorySlot[]=
		{
			"CM_Cutting_Saw"
		};
	...
	class CM_Grinder: Inventory_Base
	{
		...
		model="CM_Tools_Werkbank\grinder.p3d";
		inventorySlot[]=
		{
			"CM_Grinder"
		};
...
class CfgSoundShaders
{
	class craft_SoundShaders
	{
		samples[]=
		{
			...
			{
				"CM_Tools_Werkbank\sounds\inv_repair_kit_use_fast",
				1
			}
		};
		range=5;
